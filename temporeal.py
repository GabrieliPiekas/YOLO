...
# Se você tiver uma GPU e o OpenCV estiver configurado para usá-la, descomente as linhas abaixo
...
def detect_objects(image):
    ...
    # Preparar o blob para a detecção
    ...
    # Aplicar Non-Maximum Suppression para eliminar múltiplas detecções
    ...
    if len(indices) > 0:
        ...
        for i in indices:
            ...
            # Incrementar a contagem da classe
...
class VideoProcessor(VideoProcessorBase):
    def __init__(self):
        self.class_counts = {}
        self.frame_skip = 5  # Processar 1 a cada 5 frames para melhorar a performance
        self.frame_count = 0

    def recv(self, frame):
        img = frame.to_ndarray(format="bgr24")

        # Processar apenas um frame a cada frame_skip
...
def main():
    ...
    if option == 'Imagem':
        ...
        webrtc_ctx = webrtc_streamer(
            ...
            async_processing=True,  # Manter como True para processamento assíncrono
        )
